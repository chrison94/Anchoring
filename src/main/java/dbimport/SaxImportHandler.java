...
public class SaxImportHandler extends DefaultHandler {
	...
	boolean headerB = false, uid = false, accession = false, createdDate = false, seqRevDate = false,
			txtRevDate = false, protein = false, proteinName = false, organismB = false, source = false, common = false,
			formal = false, referenceB = false, refinfoB = false, authorsB = false, author = false, citation = false,
			volume = false, year = false, pages = false, title = false, xrefsB = false, xref = false, db = false,
			accinfo = false, molType = false, seqSpec = false, genetics = false, introns = false,
			classification = false, superFamily = false, keywordsB = false, keyword = false, featureB = false,
	...
	public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException {
		...
		if (qName.equalsIgnoreCase("accession"))
			accession = true;
		if (qName.equalsIgnoreCase("created_date"))
			createdDate = true;
		if (qName.equalsIgnoreCase("seq-rev_date"))
			seqRevDate = true;
		if (qName.equalsIgnoreCase("txt-rev_date"))
			txtRevDate = true;
		...
		if (qName.equalsIgnoreCase("common"))
			common = true;
		if (qName.equalsIgnoreCase("formal"))
			formal = true;
		...
		if (qName.equalsIgnoreCase("author"))
			author = true;
		if (qName.equalsIgnoreCase("citation"))
			citation = true;
		...
		if (qName.equalsIgnoreCase("title"))
			title = true;
		if (qName.equalsIgnoreCase("xrefs"))
			xrefsB = true;
		...
		if (qName.equalsIgnoreCase("accinfo"))
			accinfo = true;
		if (qName.equalsIgnoreCase("mol-type"))
			molType = true;
		if (qName.equalsIgnoreCase("seq-spec"))
			seqSpec = true;
		if (qName.equalsIgnoreCase("genetics"))
			genetics = true;
		if (qName.equalsIgnoreCase("introns"))
			introns = true;
		if (qName.equalsIgnoreCase("classification"))
			classification = true;
		if (qName.equalsIgnoreCase("superfamily"))
			superFamily = true;
		...
		if (qName.equalsIgnoreCase("feature"))
			featureB = true;
		if (qName.equalsIgnoreCase("feature-type"))
			featureType = true;
