		...
		if (sessionFactory == null) {
			try {
				...
				settings.put(Environment.URL,
						"jdbc:mysql://localhost:3306/dbanchoring?useTimezone=true&amp;serverTimezone=UTC&amp;useLegacyDatetimeCode=false");
				...
				MetadataSources sources = new MetadataSources(registry).addAnnotatedClass(accessions.class);
