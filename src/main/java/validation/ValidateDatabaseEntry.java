...
public class ValidateDatabaseEntry {
	...
	public static void main(String[] args) {
		...
		JSONObject dbValidate = new JSONObject()
				.put("key", "ae0c7879b116ee05556dc0a25cd89b934e451e3daa257f325d8b25d1c9601963")
				.put("type","String")
				.put("value", "12314");
	...
	// zu überprüfender Datenbankeintrag als JSON-Objekt - liefert gehashten Datenbankeintrag als String
	...
	/*
	 * Man erhält JSON von der Waves API, wenn der Datenbankeintrag bereits in der Waves-API enthalten war
	 * Das zurückgelieferte (key,value)-Paar (dbEntryHash,timestamp) wird daraufhin in einen String hintereinander gepackt
	 * und erneut gehasht. Die Methode liefert diesen Hash zurück, welcher dann an die Waves-API erneut als Key-Request gesendet wird  
	 */
	...
	/* Funktion um validieren zu können, ob der Datenbankeintrag als Hash in Verbindung mit dem Timestamp
	 * bereits in der Datenbank vorhanden war, Falls also das Objekt Empty ist -> False, True = Eintrag gibt es in der Chain
	 */
